...
19. [Git Branches: Creating, Using, and Managing](#git-branches-creating-using-and-managing)
...
## Git Branches: Creating, Using, and Managing

Branches are a core feature of Git that let you work on different versions of your project independently. They’re essential for collaboration, experimentation, and safe development.

### What is a Branch?
A branch is a pointer to a snapshot of your changes. The default branch is usually called `main` or `master`.
...
```bash
git branch -d feature/my-new-feature      # Safe delete (merged)
git branch -D feature/my-new-feature      # Force delete (not merged)
```
...
For more, see [Git Branching Documentation](https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell) and [GitHub Flow](https://docs.github.com/en/get-started/quickstart/github-flow).
